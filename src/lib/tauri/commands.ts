...
export async function scanAll(onProgress: (progress: ScanProgress) => void): Promise<ScanReport> {
...
export async function getActivityLog(limit: number = 200): Promise<ActivityEntry[]> {
