...
The Tauri v2 implementation is complete with all 13 scanners, risk-categorized confirmation flows, system tray integration, and audit trail. See the root [README.md](../README.md) for usage.
